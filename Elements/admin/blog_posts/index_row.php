...
<tr<?php echo $class; ?>>
	<td class="row-tools">
		...
		<?php endif ?>
		<?php $this->BcBaser->link('<i class="material-icons">&#xE036;</i>', array('action' => 'ajax_unpublish', $data['BlogContent']['id'], $data['BlogPost']['id']), array('title' => '非公開', 'class' => 'btn-unpublish')) ?>
		<?php $this->BcBaser->link('<i class="material-icons">&#xE039;</i>', array('action' => 'ajax_publish', $data['BlogContent']['id'], $data['BlogPost']['id']), array('title' => '公開', 'class' => 'btn-publish')) ?>
		<?php $this->BcBaser->link('<i class="material-icons">&#xE8F4;</i>', '/' . $data['BlogContent']['name'] . '/archives/' . $data['BlogPost']['no'], array('title' => '確認', 'target' => '_blank')) ?>
		<?php $this->BcBaser->link('<i class="material-icons">&#xE3C9;</i>', array('action' => 'edit', $data['BlogContent']['id'], $data['BlogPost']['id']), array('title' => '編集')) ?>
		<?php $this->BcBaser->link('<i class="material-icons">&#xE14D;</i>', array('action' => 'ajax_copy', $data['BlogContent']['id'], $data['BlogPost']['id']), array('title' => 'コピー', 'class' => 'btn-copy')) ?>
		<?php $this->BcBaser->link('<i class="material-icons">&#xE872;</i>', array('action' => 'ajax_delete', $data['BlogContent']['id'], $data['BlogPost']['id']), array('title' => '削除', 'class' => 'btn-delete')) ?>
	</td>
