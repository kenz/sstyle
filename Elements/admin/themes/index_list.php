...
<div id="CurrentTheme" class="clearfix">
	...
	<?php if ($currentTheme): ?>
		<div class="current-theme-left">
			...
			<p class="row-tools">
				<?php $this->BcBaser->link('<i class="material-icons" title="管理">&#xE30C;</i>', array('controller' => 'theme_files', 'action' => 'index', $currentTheme['name']), array('title' => '管理')) ?>
				<?php $this->BcBaser->link('<i class="material-icons" title="編集">&#xE3C9;</i>', array('action' => 'edit', $currentTheme['name']), array('title' => '編集')) ?>
				<?php $this->BcBaser->link('<i class="material-icons" title="コピー">&#xE14D;</i>', array('action' => 'ajax_copy', $currentTheme['name']), array('title' => 'コピー', 'class' => 'btn-copy')) ?>
