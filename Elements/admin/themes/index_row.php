...
<li>
	...
	<p class="row-tools">
		<?php if ($data['name'] != $this->BcBaser->siteConfig['theme']): ?>
			<?php $this->BcBaser->link('<i class="material-icons" title="適用">&#xE876;</i>', array('action' => 'apply', $data['name']), array('title' => '適用')) ?>
		<?php endif ?>
		<?php $this->BcBaser->link('<i class="material-icons" title="管理">&#xE30C;</i>', array('controller' => 'theme_files', 'action' => 'index', $data['name']), array('title' => '管理')) ?>
		<?php $this->BcBaser->link('<i class="material-icons" title="編集">&#xE3C9;</i>', array('action' => 'edit', $data['name']), array('title' => '編集')) ?>
		<?php $this->BcBaser->link('<i class="material-icons" title="コピー">&#xE14D;</i>', array('action' => 'ajax_copy', $data['name']), array('title' => 'コピー', 'class' => 'btn-copy')) ?>
		<?php $this->BcBaser->link('<i class="material-icons" title="削除">&#xE872;</i>', array('action' => 'ajax_delete', $data['name']), array('title' => '削除', 'class' => 'btn-delete')) ?>
