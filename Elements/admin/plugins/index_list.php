...
<thead>
	<tr class="list-tool">
		<th>
			<div>
				<?php $this->BcBaser->link('<i title="新規追加" class="material-icons">&#xE147;</i>新規追加', array('action' => 'add')) ?>
				<?php if (!$sortmode): ?>
					<?php $this->BcBaser->link('<i class="material-icons">&#xE164;</i>並び替え', array('sortmode' => 1)) ?>
				<?php else: ?>
					<?php $this->BcBaser->link('<i class="material-icons">&#xE164;</i>並び替え', array('sortmode' => 0)) ?>
				<?php endif ?>
			</div>
