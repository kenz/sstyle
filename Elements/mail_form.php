...
<div class="submit">
	<?php if ($freezed): ?>
		<?php echo $this->Mailform->submit('書き直す', array('div' => false, 'id' => 'BtnMessageBack')) ?>
		<?php echo $this->Mailform->submit('送信する', array('div' => false, 'id' => 'BtnMessageSubmit')) ?>
	<?php elseif ($this->action != 'submit'): ?>
		<?php echo $this->Mailform->submit('確認する', array('div' => false, 'id' => 'BtnMessageConfirm')) ?>
	<?php endif; ?>
</div>
